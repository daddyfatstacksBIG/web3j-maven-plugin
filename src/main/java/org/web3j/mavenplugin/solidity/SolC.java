...
public class SolC {
  ...
  private String evaluateSolCVersion() {
    try {
      ...
      throw new RuntimeException("Could not evaluate SolC Version from '" +
                                     getCanonicalPath() + "'",
                                 e);
    }
    throw new RuntimeException("Could not evaluate SolC Version from '" +
  ...
  private String getOS() {
    ...
    if (osName.contains("win")) {
      ...
      throw new RuntimeException("Can't find solc compiler: unrecognized OS: " +
                                 osName);
    }
  }
   ...
   * <p>
   * The first time this getter is called, a version call to solC is executed.
   * (<code>solc
   * --version</code>)
   *
   * @return
